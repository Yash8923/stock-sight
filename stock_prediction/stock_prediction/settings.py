...
EMAIL_BACKEND = 'django.core.mail.backends.console.EmailBackend'  # Change this for real emails
EMAIL_HOST = 'smtp.gmail.com'  # Use your email provider
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'your_email@gmail.com'  # Your email
EMAIL_HOST_PASSWORD = 'your_password'  # App password (not direct password)
